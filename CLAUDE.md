...
⚠️ **국가별 SEO 블로그 확장 착수(2026-08-13)** — 별도 프로젝트
`../seo-blog/CLAUDE.md`에서 진행 중(health-shorts 하위 아님, 여러
콘텐츠 소스가 공유하는 독립 프로젝트). health-shorts는 트랙 B(기존
글로벌 전개, 이 문서 표준 워크플로우 그대로)만 담당.
