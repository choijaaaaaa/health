...
⚠️ **국가별 SEO 블로그 확장 착수(2026-08-13)** — `BLOG_EXPANSION.md` 참고.
이 CLAUDE.md의 기존 파이프라인(카드뉴스/숏폼)과 별개 트랙으로 병렬 진행
중 — 세션을 2개로 나눠 트랙 A(사이트 인프라)/트랙 B(기존 헬스숏츠 글로벌
전개, 이 CLAUDE.md 표준 워크플로우 그대로)로 분담.
