...
- **03~07 → 미드저니 먼저**, 나온 스틸을 `1_스틸/`에 `<번호>_<이름>.jpg`로 넣고 Flow.
...
| 02 | `act_press_swollen_eyelid` | 대사_22 | Flow만 |
| 03 | `act_cover_blister_gauze` | 고령_15 | 미드저니 → Flow |
| 04 | `act_vaccine_shot_arm` | 고령_15 | 미드저니 → Flow |
| 05 | `act_apply_face_cream` | 머리_14 | 미드저니 → Flow |
| 06 | `act_drink_alcohol_with_painkiller` | 소화_14 | 미드저니 → Flow |
| 07 | `act_check_jaw_mirror` | 여성_7 | 미드저니 → Flow |
...
## 02. `act_press_swollen_eyelid` — 대사_22 (6초)
...
## 03. `act_cover_blister_gauze` — 고령_15 (6초)

**레퍼런스**: `assets_library/xray/stills/canon_organs.jpg` — Omni Reference / 저장: `03_act_cover_blister_gauze.jpg`
...
## 04. `act_vaccine_shot_arm` — 고령_15 (6초)

**레퍼런스**: `assets_library/xray/stills/canon_organs.jpg` — Omni Reference / 저장: `04_act_vaccine_shot_arm.jpg`
...
**레퍼런스**: `assets_library/xray/stills/canon_organs.jpg` — Omni Reference / 저장: `05_act_apply_face_cream.jpg`
...
**레퍼런스**: `assets_library/xray/stills/canon_organs.jpg` — Omni Reference / 저장: `06_act_drink_alcohol_with_painkiller.jpg`
...
**레퍼런스**: `assets_library/xray/stills/canon_organs.jpg` — Omni Reference / 저장: `07_act_check_jaw_mirror.jpg`
