...
# WHY -16dB(2026-08-05, 첫 -24dB 버전 청취 후 "소리 조금 더 키워야할듯" 피드백):
# -24dB는 원곡 자체 평균 음량(대략 -23dB)까지 겹쳐서 실질적으로 거의 안
# 들릴 정도였다 — 내레이션(-16dB대)보다는 여전히 확실히 아래지만 존재감은
# 느껴지게 8dB 올림. 필요시 이 값만 조정하면 전체 파이프라인에 일괄 반영된다.
BGM_VOLUME_DB = -16
FADE_SEC = 1.5
